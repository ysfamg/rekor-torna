...
export async function generateMetadata() {
  ...
  return {
    title: pageContent?.seoTitle || "Gizlilik Politikası | Rekor Torna Hidrolik",
    description: pageContent?.seoDesc || "Gizlilik politikası ve kişisel verilerin korunması",
  }
}
      ...
      <section className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            {pageContent?.title || "Gizlilik Politikası"}
          </h1>
